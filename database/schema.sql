...
-- Product.image is populated for all 50 fictional sample products.
-- Other unprovided product details remain NULL.
...
--
-- Product.image filenames are linked below to the included generated images.
-- Other fields absent from the source remain NULL:
-- barcode, ingredients, how_to_use, warnings, skin_tone and skin_type.
-- ============================================================
...
-- Link the sample catalogue to generated product images in
-- assets/images/products/. These same filenames are included in
-- database/link_all_50_product_images.sql for existing databases.
