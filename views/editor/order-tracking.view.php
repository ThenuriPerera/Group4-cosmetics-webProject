...
<div class="lg-container">
    ...
    <div class="lg-topbar">
        <div class="lg-title-area">
            ...
            <div>
                <p class="lg-eyebrow">Operations Center</p>
                <h1 class="lg-title">Order Tracking</h1>
                <p class="lg-subtitle">
    ...
    <div class="lg-stats">
        <div class="lg-stat">
            <div class="lg-stat-icon">📦</div>
            <div class="lg-stat-label">Total Orders</div>
            <div class="lg-stat-number"><?= $totalOrders ?></div>
        </div>

        <div class="lg-stat">
            <div class="lg-stat-icon">⏳</div>
            <div class="lg-stat-label">Processing</div>
            <div class="lg-stat-number"><?= $processingOrders ?></div>
        </div>

        <div class="lg-stat">
            <div class="lg-stat-icon">🚚</div>
            <div class="lg-stat-label">Shipped</div>
            <div class="lg-stat-number"><?= $shippedOrders ?></div>
        </div>

        <div class="lg-stat">
            <div class="lg-stat-icon">✓</div>
            <div class="lg-stat-label">Delivered</div>
            <div class="lg-stat-number"><?= $deliveredOrders ?></div>
        </div>
    </div>
    ...
    <?php if (!empty($orders)): ?>
        ...
        <div class="lg-toolbar">
            ...
            <select id="statusFilter" class="lg-filter">
        ...
        <?php foreach ($orders as $order): ?>
            ...
            >
                ...
                <div class="lg-order-header">
                    ...
                    <span class="lg-status <?= $statusClass ?>">
                ...
                <div class="lg-info-grid">
                    ...
                    <div class="lg-info">
                        <span class="lg-info-label">Order Total</span>
                    ...
                    <div class="lg-info">
                        <span class="lg-info-label">Delivery</span>
                    ...
                    <div class="lg-info">
                        <span class="lg-info-label">Courier</span>
                ...
                <div class="lg-update-area">
                    ...
                    <form method="POST" class="lg-form">
                            ...
                            <div class="lg-field">
                                ...
                                <select name="delivery_status">
                                    ...
                                    <?php foreach ($deliveryStatuses as $option): ?>
                                        ...
                                        <option
                                            value="<?= htmlspecialchars($option) ?>"
                                            <?= ($order['delivery_status'] ?? 'Pending') === $option
                                                ? 'selected'
                                                : ''
                                            ?>
                                        >
                        ...
                        <div class="lg-gps-box">

                            <div class="lg-gps-title">
                                📍 GPS Tracking
                            </div>

                            <div class="lg-gps-grid">
                            ...
                            <div class="lg-gps-status">

                                <?php if (
                                    !empty($order['current_latitude']) &&
                                    !empty($order['current_longitude'])
                                ): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    ⚪ GPS Offline — tracking has not started.

                                <?php endif; ?>

                            </div>

                            <div class="lg-gps-buttons">

                                <button
                                    type="button"
                                    class="lg-gps-button lg-start-gps start-gps"
                                >
                                    📍 Start GPS Tracking
                                </button>
                                ...
                                <button
                                    type="button"
                                    class="lg-gps-button lg-stop-gps stop-gps"
                                    disabled
                                >
                                    ■ Stop GPS Tracking
                                </button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    document.querySelectorAll('.lg-order-card').forEach(function (card) {

        const startButton =
            card.querySelector('.start-gps');

        const stopButton =
            card.querySelector('.stop-gps');

        const latitudeInput =
            card.querySelector('.gps-latitude');

        const longitudeInput =
            card.querySelector('.gps-longitude');

        const gpsStatus =
            card.querySelector('.lg-gps-status');

        const mapLink =
            card.querySelector('.lg-map-link');
        ...
        function success(position) {
            ...
            gpsStatus.innerHTML =
                '🟢 GPS tracking active. Location updated on this device.';
        ...
        stopButton.addEventListener('click', function () {
            ...
            gpsStatus.textContent =
                '⚪ GPS tracking stopped. Click "Save Tracking Update" to save the last location.';
        });
